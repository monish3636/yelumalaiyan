...
<script type="text/javascript">
    ...
    <?php 
        if($this->session->userdata['direct_invoice_per']['delete']==1){ ?>
            var flag=0;
            var field=document.forms.posnic;
            for (i = 0; i < field.length; i++){
                if(field[i].checked==true){
            ...
            if (flag<1) {
                ...
                bootbox.confirm("<?php echo $this->lang->line('Are you Sure To Delete')."".$this->lang->line('direct_invoice') ?>", function(result) {
                    if(result){
                        var posnic=document.forms.posnic;
