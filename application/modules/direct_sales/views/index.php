...
<script type="text/javascript">
    ...
    function save_new_order(){
         <?php if($this->session->userdata['direct_sales_per']['add']==1){ ?>
                ...
                get_table_data();
                 var inputs = $('#parsley_reg').serialize()+"&no_of_item="+$("#selected_item_table").dataTable().fnGetNodes().length;
                      $.ajax ({
                            url: "<?php echo base_url('index.php/direct_sales/save')?>",
                            data: inputs,
                            type:'POST',
                            complete: function(response) {
                                if(response['responseText']=='TRUE'){
                                      $.bootstrapGrowl('<?php echo $this->lang->line('direct_sales').' '.$this->lang->line('added');?>', { type: "success" });                                                                                  
    ...
    function update_order(){
         <?php if($this->session->userdata['direct_sales_per']['edit']==1){ ?>
                ...
                get_table_data();
                 var inputs = $('#parsley_reg').serialize()+"&no_of_item="+$("#selected_item_table").dataTable().fnGetNodes().length;
                          $.ajax ({
                            url: "<?php echo base_url('index.php/direct_sales/update')?>",
                            data: inputs,
                            type:'POST',
                            complete: function(response) {
                                if(response['responseText']=='TRUE'){
                                      $.bootstrapGrowl('<?php echo $this->lang->line('direct_sales').' '.$this->lang->line('updated');?>', { type: "success" });                                                                                  
                                       $("#dt_table_tools").dataTable().fnDraw();
                                       $("#parsley_reg").trigger('reset');
                                       posnic_direct_sales_lists();
                                       refresh_items_table();
    ...
    $(document).ready( function () {
        ...
        $('#parsley_reg #items').select2({
            ...
            ajax: {
                url: '<?php echo base_url() ?>index.php/direct_sales/search_items/',
        ...
        $('#parsley_reg #first_name').select2({
            ...
            ajax: {
                url: '<?php echo base_url() ?>index.php/direct_sales/search_customer',
                data: function(term, page) {
                    return {types: ["exercise"],
                        limit: -1,
                        term: term
...
$("#parsley_reg #first_name").select2('data', {id:'',text: 'Search Customer'});
    <?php if($this->session->userdata['direct_sales_per']['add']==1){ ?>
             $.ajax({                                      
                             url: "<?php echo base_url() ?>index.php/direct_sales/order_number/",                      
                             data: "", 
                             dataType: 'json',               
    ...
    function posnic_direct_sales_lists(){
        invoice_enable();
        ...
        $('#posnic_add_direct_sales').removeAttr("disabled");
        $('#direct_sales_lists').attr("disabled",'disabled');
    }
function clear_add_direct_sales(){
      $("#parsley_reg").trigger('reset');
      refresh_items_table();
}
function clear_update_direct_sales(){
      $("#parsley_reg").trigger('reset');
      refresh_items_table();
      edit_function($('#direct_sales_guid').val());
}
    ...
    <div class="container">
            <div class="row">
                <div class="col col-lg-7">
                        <a href="javascript:posnic_add_new()" id="posnic_add_direct_sales" class="btn btn-default" ><i class="icon icon-user"></i> <?php echo $this->lang->line('addnew') ?></a>  
                     
                        <a href="javascript:direct_sales_group_approve()" class="btn btn-default" id="deactive"  ><i class="icon icon-play"></i> <?php echo $this->lang->line('approve') ?></a>
                        ...
                        <a href="javascript:posnic_direct_sales_lists()" class="btn btn-default" id="direct_sales_lists"><i class="icon icon-list"></i> <?php echo $this->lang->line('direct_sales') ?></a>
...
<section class="container clearfix main_section">
        <div id="main_content_outer" class="clearfix">
            <div id="main_content">
                    ...
                    echo form_open('direct_sales/direct_sales_manage',$form) ?>
                        <div class="row">
                            <div class="col-sm-12" id="user_list"><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                            <h4 class="panel-title"><?php echo $this->lang->line('direct_sales') ?></h4>                                                                               
                                    </div>
        ...
        if( $('#parsley_reg #item_id').val()!="" &&  $('#parsley_reg #price').val()!=""   && $('#parsley_reg #quantity').val()!=""){
            if(data_table_duplicate('new_item_row_id_'+$('#parsley_reg #stock_id').val())){
                if($('#selected_item_table #new_item_row_id_'+$('#parsley_reg #stock_id').val()).length){
                    ...
                    $('#newly_added #new_item_tax_'+stock).val(tax1);
                    $('#newly_added #new_item_tax2_'+stock).val(tax2);
                ...
                <input type="hidden" name="new_item_tax[]" value="'+tax1+'" id="new_item_tax_'+stock+'"> \n\
                <input type="hidden" name="new_item_tax2[]" value="'+tax2+'" id="new_item_tax2_'+stock+'"> \n\
...
<section id="add_new_order" class="container clearfix main_section">
     <?php   $form =array('id'=>'parsley_reg',
       ...
       echo form_open_multipart('direct_sales/upadate_pos_direct_sales_details/',$form);?>
    ...
    <div id="main_content" style="padding: 0 14px !important;">
        ...
        <input type="hidden" name="dummy_discount_amount" id="dummy_discount_amount" >
                         <div class="row">
                          <div class="panel panel-default">
                              <div class="panel-heading" >
                                     <h4 class="panel-title"><?php echo $this->lang->line('direct_sales')." ".$this->lang->line('details') ?></h4>                                                                               
                               </div>
                                       ...
                                       <div id="" class="col col-sm-12" style="padding-right: 25px;padding-left: 25px">
                                           <div class="row">
                                               <div class="col col-sm-2" >
                                                   <div class="form_sep customers_select_2">
                                                        ...
                                                        <input type="hidden" id="direct_sales_guid" name="direct_sales_guid">
                                                  </div>
                                               </div>
                                               <div class="col col-sm-2" >
                                                    <div class="form_sep">
                                                ...
                                                <div class="col col-sm-2" >
                                                   <div class="form_sep">
                                                            <label for="discount" ><?php echo $this->lang->line('discount') ?>%</label>													
                                                                     <?php $discount=array('name'=>'sales_discount',
                                                                                        'class'=>'  form-control',
                                                                                        'id'=>'id_discount',
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col col-sm-2" id="sales_bill_date_div">
                                                   <div class="form_sep">
                                          ...
                                          <div class="col col-sm-6"  >
                                                   <div class="form_sep " id="save_clear">
                                                       <label for="remark" >&nbsp;</label>	
                                                        <a href="javascript:clear_add_direct_sales()" class="btn btn-default"  ><i class="icon icon-refresh"></i> <?php echo " ".$this->lang->line('clear') ?></a>
                                                  </div>
...
<section class="container clearfix main_section" id="invoice_settings" style="display: none">
    ...
    <div id="main_content_outer" class="clearfix" >
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#st_purchase"><?php echo $this->lang->line('direct_sales')." ".$this->lang->line('details') ?></a></li>
                                ...
                                <div class="tab-content">
                                    <div id="st_purchase" class="tab-pane active">
                                        <div class="col-sm-3">
                                            <div class="form-group ">
                                                    <label for="posnic_order_id" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('id') ?></label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group ">
                                                    <label for="posnic_number" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('no') ?></label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_date" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('date') ?></label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_barcode" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('barcode') ?></label>													
                                    ...
                                    <div id="st_branch" class="tab-pane">
                                           <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_branch_code" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('branch')." ". $this->lang->line('code') ?></label>													
                                           ...
                                           <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_branch_name" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('branch')." ". $this->lang->line('name') ?></label>													
      ...
      <div class="col-sm-3">
                                    ...
                                    <div id="st_invoice" class="tab-pane">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_direct_sales_subtotal" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('subtotal') ?></label>													
                                                     
                                                        <?php $posnic_direct_sales_subtotal=array('name'=>'posnic_direct_sales_subtotal',
                                                                               'class'=>' form-control ',
                                                                                'value'=>1,
                                                                               'id'=>'posnic_direct_sales_subtotal');
                                                        echo form_checkbox($posnic_direct_sales_subtotal)?>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_discount" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('discount') ?> </label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_frieght" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('frieght') ?> </label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_round_off_amount" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('round_off_amount') ?> </label>													
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="posnic_grand_total" ><?php echo $this->lang->line('direct_sales')." ". $this->lang->line('grand_total') ?> </label>													
    ...
    function posnic_delete(){
        <?php
        if($this->session->userdata['direct_sales_per']['delete']==1){ ?>
            var flag=0;
            ...
            if (flag<1) {
                $.bootstrapGrowl('<?php echo $this->lang->line('Select Atleast One')."".$this->lang->line('sales');?>', { type: "warning" });
            }else{
                bootbox.confirm("<?php echo $this->lang->line('Are you Sure To Delete')."".$this->lang->line('sales') ?>", function(result) {
                    if(result)
                    {
                        ...
                        for (i = 0; i < posnic.length; i++){                           
                            if(posnic[i].checked==true){ 
                                ...
                                $.ajax({
                                    ...
                                    complete: function(response) {
                                        if(response['responseText']=='TRUE'){
                                            $.bootstrapGrowl($('#order__number_'+guid).val()+ ' <?php echo $this->lang->line('sales') ?>  <?php echo $this->lang->line('deleted');?>', { type: "error" });
                                            $("#dt_table_tools").dataTable().fnDraw();
                                            ...
                                            $.bootstrapGrowl('<?php echo $this->lang->line('You Have NO Permission')." ".$this->lang->line('to')." ".$this->lang->line('approve')." ".$this->lang->line('sales');?>', { type: "error" });                       
                                        }
                                    }
                                });
                            }
            ...
            $.bootstrapGrowl('<?php echo $this->lang->line('You Have NO Permission To Delete')." ".$this->lang->line('sales');?>', { type: "error" });                       
            <?php
        }
        ?>
    }
    ...
    function direct_sales_group_approve(){
        <?php
        if($this->session->userdata['direct_sales_per']['approve']==1){ ?>
            ...
            if (flag<1) {
                $.bootstrapGrowl('<?php echo $this->lang->line('Select Atleast One')."".$this->lang->line('direct_sales');?>', { type: "warning" });
            }else{
                var posnic=document.forms.posnic;
