...
<script type="text/javascript" charset="utf-8">
    var point=3; 
          $(document).ready( function () {
                 $('#selected_item_table .dataTables_empty').html('<?php echo $this->lang->line('please_select').' '.$this->lang->line('items')." ".$this->lang->line('for')." ".$this->lang->line('stock_price_changer') ?>');
           ...
           $('#dt_table_tools').dataTable({
				      ...
				      "bServerSide": true,
                               ...
                               return nRow;
                                      ...
                                      "sAjaxSource": "<?php echo base_url() ?>index.php/stock_price_changer/data_table",
                                       aoColumns: [  
        ...
        null,null,  null,  null,  null,  null, null, null, 
           ...
           function get_stock(guid){
                        ...
                        <?php if($this->session->userdata['stock_price_changer_per']['price_change']==1){ ?>
                            ...
                            $('#loading').modal('show');
                            $.ajax({                                      
                             url: "<?php echo base_url() ?>index.php/stock_price_changer/get_stock/"+guid,                      
                             data: "", 
                             dataType: 'json',               
                             ...
                             { 
                                ...
                                $('#stock_price_changer_lists').removeAttr("disabled");                               
                        ...
                        <?php }else{?>
                                 $.bootstrapGrowl('<?php echo $this->lang->line('You Have NO Permission To Edit')." ".$this->lang->line('stock_price_changer');?>', { type: "error" });                       
                        <?php }?>
                       }
		</script>
