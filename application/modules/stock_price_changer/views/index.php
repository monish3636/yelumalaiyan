...
<script type="text/javascript">
    ...
    function posnic_stock_price_changer_lists(){
        $("#user_list").show('slow');
        $('#update_stock_section').hide();
        $('#stock_price_changer_lists').attr("disabled",'disabled');
    }
    function update_stock(){
        <?php if($this->session->userdata['stock_price_changer_per']['price_change']==1){ ?>
            if($('#parsley_reg').valid()){
                var inputs = $('#parsley_reg').serialize();
                $.ajax ({
                    url: "<?php echo base_url('index.php/stock_price_changer/update')?>",
                    data: inputs,
                    type:'POST',
                    complete: function(response) {
                        if(response['responseText']=='TRUE'){
                              $.bootstrapGrowl('<?php echo $this->lang->line('stock_price_changer').' '.$this->lang->line('updated');?>', { type: "success" });                                                                                  
                               $("#dt_table_tools").dataTable().fnDraw();
                               $("#parsley_reg").trigger('reset');
                               posnic_stock_price_changer_lists();
                              ...
                              $.bootstrapGrowl('<?php echo $this->lang->line('You Have NO Permission To Add')." ".$this->lang->line('stock_price_changer');?>', { type: "error" });                           
                        }
                    }
                });
            }else{
    ...
    <div class="container">
            <div class="row">
                <div class="col col-lg-7">
                        ...
                        <a href="javascript:posnic_stock_price_changer_lists()" class="btn btn-default" id="stock_price_changer_lists"><i class="icon icon-list"></i> <?php echo $this->lang->line('stock_price_changer') ?></a>
...
<section class="container clearfix main_section">
        <div id="main_content_outer" class="clearfix">
            <div id="main_content">
                    ...
                    echo form_open('stock_price_changer/stock_price_changer_manage',$form) ?>
                        <div class="row">
                            <div class="col-sm-12" id="user_list"><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                            <h4 class="panel-title"><?php echo $this->lang->line('stock_price_changer') ?></h4>                                                                               
                                    </div>
...
<section id="update_stock_section" class="container clearfix main_section">
     <?php   $form =array('id'=>'parsley_reg',
       ...
       echo form_open_multipart('stock_price_changer/upadate_pos_stock_price_changer_details/',$form);?>
    ...
    <div id="main_content" style="padding: 0 14px !important;">
        ...
        <input type="hidden" name="stock_id" id="stock_id" >
                      ...
                      <div class="col col-lg-6">
                          <div class="panel panel-default">
                              <div class="panel-heading" >
                                     <h4 class="panel-title"><?php echo $this->lang->line('stock_price_changer')." ".$this->lang->line('details') ?></h4>                                                                               
                               </div>
