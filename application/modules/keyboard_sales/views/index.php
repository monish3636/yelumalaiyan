...
/*        width: 120px !important;*/
    ...
    #selected_item_table tr th:nth-child(10),#selected_item_table tr td:nth-child(10){
      width: 20px;
    }
                ...
                if(data.length>1){
                    ...
                    for(var i=0;i<data.length;i++){
                        if(data[i]['deco_guid']){
                            ...
                            var tax_type2=data[i]['tax2_type']+"-"+tax_value2+"%";                               
                    ...
                    if(data_table_duplicate('new_item_row_id_'+data[0]['guid'])){
                        ...
                        var tax_Inclusive2=$('#new_item_row_id_'+data[0]['guid']+' #items_tax_inclusive2').val();
                        var tax_value2=$('#new_item_row_id_'+data[0]['guid']+' #items_tax_value2').val();
                        var tax_type2=$('#new_item_row_id_'+data[0]['guid']+' #items_tax_type2').val();
                        ...
                        tax1=tax1.toFixed(point);
                        tax2=parseFloat(tax2);
                        tax2=tax2.toFixed(point);
                        if(isNaN(parseFloat(tax1)) || tax1==0){
                            tax1=0;
                            var tax_text1='';
                        }else{
                            var tax_text1=tax1+':'+tax_type+'('+type1+')';
                        }
                        if(isNaN(parseFloat(tax2)) || tax2==0){
                            tax2=0;
                            var tax_text2=0;
                        }else{
                        ...
                        var old_discount=$('#new_item_row_id_'+data[0]['guid']+' #items_discount').val();
                        var old_tax1=$('#new_item_row_id_'+data[0]['guid']+' #items_tax_amount').val();
                        var old_tax2=$('#new_item_row_id_'+data[0]['guid']+' #items_tax_amount2').val();
                        $('#selected_item_table #new_item_row_id_'+data[0]['guid']+' td:nth-child(6)').html(tax_text1);
                        $('#selected_item_table #new_item_row_id_'+data[0]['guid']+' td:nth-child(7)').html(tax_text2);
                        $('#selected_item_table #new_item_row_id_'+data[0]['guid']+' td:nth-child(8)').html(discount);
                        $('#selected_item_table #new_item_row_id_'+data[0]['guid']+' td:nth-child(9)').html(total);
                        $('#new_item_row_id_'+data[0]['guid']+' #quty_'+data[0]['guid']).val(parseFloat(quty));
                        $('#new_item_row_id_'+data[0]['guid']+' #items_total').val(total);
                        $('#new_item_row_id_'+data[0]['guid']+' #items_tax_amount').val(tax1);
                        $('#new_item_row_id_'+data[0]['guid']+' #items_tax_amount2').val(tax2);
                        $('#new_item_row_id_'+data[0]['guid']+' #items_discount').val(discount);
                        ...
                        if(data[0]['deco_guid']){
                            ...
                            var tax_value2=data[0]['tax2_value'];
                            var tax_type2=data[0]['tax2_type']+"-"+tax_value2+"%";                               
                            var tax_Inclusive2=data[i]['tax_inclusive2'];
                            var per=0;
                            ...
                            var tax_value2=data[0]['tax2_value'];
                            var tax_type2=data[0]['tax2_type']+"-"+tax_value2+"%";                               
                            var tax_Inclusive2=data[0]['tax_inclusive2'];
                        ...
                        if($('#parsley_reg #total_item_discount_amount').val()==0 || $('#parsley_reg #total_item_discount_amount').val()==""){
                            $('#parsley_reg #total_item_discount_amount').val(discount);
                        }else{
                            $('#parsley_reg #total_item_discount_amount').val(parseFloat($('#parsley_reg #total_item_discount_amount').val())+parseFloat(discount));
                        }
...
<script type="text/javascript">
    ...
    function table_row_total(id){
        ...
        var tax_Inclusive2=$('#'+row+' #items_tax_inclusive2').val();
        var tax_value2=$('#'+row+' #items_tax_value2').val();
        var tax_type2=$('#'+row+' #items_tax_type2').val();
        var per=$('#'+row+' #items_discount_per').val();
        var discount=0;
        if(isNaN(parseFloat(quty))){
            quty=0;
        }
        ...
        var num = parseFloat(total);
        total=num.toFixed(point);       
        var old_discount=$('#'+row+' #items_discount').val();
        var old_tax1=$('#'+row+' #items_tax_amount').val();
        var old_tax2=$('#'+row+' #items_tax_amount2').val();
        $('#selected_item_table #'+row+' td:nth-child(6)').html(tax_text1);
        $('#selected_item_table #'+row+' td:nth-child(7)').html(tax_text2);
        $('#selected_item_table #'+row+' td:nth-child(8)').html(discount);
        $('#selected_item_table #'+row+' td:nth-child(9)').html(total);
        $('#'+row+' #quty_'+row).val(parseFloat(quty));
        $('#'+row+' #items_tax_amount').val(tax1);        
        $('#'+row+' #items_tax_amount2').val(tax2);        
        $('#'+row+' #items_discount').val(discount);        
        ...
        if(tax_Inclusive==0){
            ...
            if($('#parsley_reg #total_tax').val()==0){
                ...
                var total_tax=num.toFixed(point);
                $('#parsley_reg #total_tax').val(parseFloat(total_tax)+parseFloat(tax1));
            }
        }
        ...
        if(tax_Inclusive2==0){
            ...
            if($('#parsley_reg #total_tax').val()==0){
                ...
                var num = parseFloat($('#parsley_reg #total_tax').val());
                var total_tax=num.toFixed(point);   
                $('#parsley_reg #total_tax').val(parseFloat(total_tax)+parseFloat(tax2));
            }
        }
    ...
    $(document).ready( function () {
        $('#items').change(function() {
            if($('#items').select2('data').deco_guid)
            {
                ...
                $('#parsley_reg #tax_type').val($('#items').select2('data').tax_type);
                $('#parsley_reg #tax_Inclusive').val($('#items').select2('data').tax_Inclusive);
                $('#parsley_reg #tax_value2').val($('#items').select2('data').tax_value2);
                $('#parsley_reg #tax_type2').val($('#items').select2('data').tax_type2);
                $('#parsley_reg #tax_Inclusive2').val($('#items').select2('data').tax_Inclusive2);
                ...
                $('#parsley_reg #tax_type').val($('#items').select2('data').kit_tax_type);
                $('#parsley_reg #tax_Inclusive').val($('#items').select2('data').kit_tax);
                ...
                if($('#items').select2('data').discount==0){
                    $('#parsley_reg #discount').val(0);  
                }else{
...
<script type="text/javascript">
    ...
    function net_amount(){
        ...
        if(isNaN($('#parsley_reg #stock_quty').val()) || isNaN($('#parsley_reg #quantity').val())){
            ...
            if($('#parsley_reg #discount').val()!="" && $('#parsley_reg #discount').val()!=0){
                ...
                $('#tax_label').text('<?php echo $this->lang->line('tax') ?>'+ 1);
                $('#tax1').val(tax1);
                $('#tax_label2').text('<?php echo $this->lang->line('tax') ?>' +2);
                $('#tax2').val(tax2);
        ...
        if(isNaN($('#parsley_reg #tax1').val())){
            $('#parsley_reg #tax1').val(0);
        }
        if(isNaN($('#parsley_reg #tax2').val())){
            $('#parsley_reg #tax2').val(0);
        }
    ...
    function copy_items(){
        if( $('#parsley_reg #item_id').val()!="" &&  $('#parsley_reg #price').val()!=""   && $('#parsley_reg #quantity').val()!=""){
            if(data_table_duplicate('new_item_row_id_'+$('#parsley_reg #stock_id').val())){    
                ...
                var tax_Inclusive2=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_inclusive2').val();
                var tax_value2=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_value2').val();
                var tax_type2=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_type2').val();
                ...
                total=parseFloat(total);
                total=total.toFixed(point);                       
                var old_discount=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_discount').val();
                var old_tax1=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_amount').val();
                var old_tax2=$('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_amount2').val();
                ...
                $('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_amount').val(tax1);
                $('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_tax_amount2').val(tax2);
                $('#new_item_row_id_'+$('#parsley_reg #stock_id').val()+' #items_discount').val(discount);
                var amount=parseFloat($('#parsley_reg #total_amount').val())+parseFloat(total)-parseFloat(old_total)
                amount=amount.toFixed(point);
                if(tax_Inclusive==0){
                     tax1=parseFloat(tax1)-parseFloat(old_tax1);
    ...
    function new_grand_total(){
        ...
        if (isNaN($("#parsley_reg #demo_grand_total").val())) 
            $("#parsley_reg #grand_total").val(0);
        if (isNaN($("#parsley_reg #total_item_discount_amount").val())) 
            $("#parsley_reg #total_item_discount_amount").val(0);
        if (isNaN($("#parsley_reg #total_tax").val())) 
            $("#parsley_reg #total_tax").val(0);
    }
