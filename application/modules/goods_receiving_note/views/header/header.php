            ...
            $.ajax({                                      
                ...
                { 
                        if(data[1]['posnic_grn']==1){
                            $('#invoice_posnic_grn_id').show();
                              $('#invoice_posnic_grn_id').html(data[0][0]['grn_no'])
                        }else{
                            $('#invoice_posnic_grn_id').hide();
                        }
